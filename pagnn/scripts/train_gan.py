...
#     parser.add_argument('--training-permutations', default='seq',
# choices=['seq', 'adj', 'seq.adj'])
...
#     training_datagen = get_datagen_gan('training', data_path, args.training_min_seq_identity,
